...
print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
print("📊 Отчёт по проверке текста на «человечность»")
print(f"Файл: {os.path.basename(path)}  Количество символов: {total_chars}")
print("")
print("Плотность связующих фраз (количество на тысячу символов)")
...
print("")
print("Абстрактная перегрузка (примеры предложений с ≥2 абстрактными словами)")
if abstract_top:
...
print("  - Разбивайте слишком длинные цепочки предложений; объединяйте избыточно короткие для создания динамики")
print("  - Проверьте, можно ли удалить или естественно заменить связующие фразы")
print("  - Перед написанием составьте 3 примера из жизни в качестве опорных точек")
PY