...
# Скрипт для создания плана творчества
...
echo "Создание плана творчества"
echo "============"
...
if [ -f "$PLAN_FILE" ]; then
    ...
    echo ""
    echo "📝 Будет создан новый план творчества"
fi

echo ""
echo "Путь к файлу плана: $PLAN_FILE"
echo ""
echo "Готово к созданию плана творчества"