...
**Текущая архитектура novel-writer-cn**:
...
| Аспект | novel-writer-cn | Платформа Xingyue | Разница |
|---|---|---|---|
...
node_modules/novel-writer-cn/      # Встроенные пакеты npm
...
- [Существующая архитектура novel-writer-cn](../../README.md)
