...
if abstract_top:
  ...
  print("  Существенных фрагментов с абстрактной перегрузкой не обнаружено")

print("")
print("Рекомендации")
print("  - Заменяйте пустые фразы и абстрактные существительные конкретными действиями/предметами/запахами")
print("  - Разбавляйте длинные предложения; объединяйте слишком короткие, чтобы создать ритмичность")
print("  - Проверьте, можно ли удалить связующие слова или заменить их естественными переходами")
