...
print("  - Разбивайте слишком длинные цепочки предложений; объединяйте слишком короткие для создания ритма")
print("  - Проверьте, можно ли удалить связующие слова или сделать переход более естественным")
print("  - Перед написанием составьте 3 примера из жизни в качестве ориентиров")
PY
```