...
if [ ${#missing[@]} -gt 0 ]; then
    ...
    if [ ! -f "$PLAN_FILE" ]; then
        echo "  3. /plan - Составление творческого плана"
    fi
    exit 1
fi
...
if [ -f "$TASKS_FILE" ]; then
    echo ""
    echo "📋 Файл задач существует, существующие задачи будут обновлены"
...
echo "  - Доработку профилей персонажей"
echo "  - Дополнение документации по мироустройству"
