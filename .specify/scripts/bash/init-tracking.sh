...
echo ""
echo "💡 Следующие шаги:"
echo "   1. Начните писать с помощью команды /write (данные отслеживания будут обновляться автоматически)"
echo "   2. Регулярно просматривайте сводный отчет с помощью команды /track"
